    ...
    >
      <div class="zfile-index-setting-drawer-body">
        ...
        <div class="zfile-index-setting-drawer-group">
          ...
          <div class="zfile-index-setting-drawer-blockCheckbox">
            <el-tooltip effect="dark" content="列表模式" placement="bottom">
              <div
                class="zfile-index-setting-drawer-item"
                :class="{ current: zfileSettingCache.view.type === 'table' }"
                @click="zfileSettingCache.view.type = 'table'"
              >
                <Bars3Icon></Bars3Icon>
              </div>
            </el-tooltip>
            <el-tooltip effect="dark" content="图标模式" placement="bottom">
              <div
                class="zfile-index-setting-drawer-item"
                :class="{ current: zfileSettingCache.view.type === 'card' }"
                @click="zfileSettingCache.view.type = 'card'"
              >
        ...
        <div class="zfile-index-setting-drawer-group">
          ...
          <div class="text-sm text-gray-400">如已处于画廊模式，需重新启用画廊模式生效.</div>
          ...
          <div class="flex justify-between">
            <div class="w-full text-base font-medium">名称显示模式</div>
          ...
          <div class="flex justify-between">
            <div class="w-full text-base font-medium">双击预览模式</div>
        ...
        <div class="mt-10 text-sm text-gray-400">Tips: 设置会自动保存，刷新后仍有效.</div>
        ...
        <div class="zfile-index-setting-drawer-group">
          ...
          <div class="my-auto flex justify-between">
            ...
            <TrashIcon class="h-6 w-6 cursor-pointer text-red-500" @click="clearPwdCache" />
          </div>
        </div>
      </div>
    </el-drawer>
    ...
    .zfile-index-setting-drawer-group {
      ...
      .zfile-index-setting-drawer-blockCheckbox {
        ...
        .zfile-index-setting-drawer-item {
          @apply cursor-pointer rounded-lg hover:bg-gray-50;
          svg {
            @apply h-12 w-12 p-3;
          }
        }
