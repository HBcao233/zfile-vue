<template>
  <div class="zfile-pdf-viewer">
    <div class="app-header">
      <div v-if="isLoading">
        <span v-if="loadingProgress < 100"> 加载 {{ loadingProgress }}% </span>
        <span v-else> 渲染所有页面中... </span>
      </div>
      <div v-else>
...
.app-header {
  ...
  color: #ddd;
  @apply flex content-between justify-between bg-gray-600 p-2 sm:p-4;
}
