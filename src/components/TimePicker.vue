<template>
  <div v-if="items" class="flex w-full flex-wrap">
    <div v-for="(item, index) in props.modelValue" :key="item.second" class="mb-4 w-full">
      <div class="flex items-center">
        ...
        ></el-input-number>
        <el-select v-model="item.unit" class="ml-1 min-w-[75px]" @change="computeSecond(item)">
          <el-option
        ...
        <button
          ...
          type="button"
          class="ml-2 rounded-md bg-blue-500 px-2 py-2 font-bold text-white hover:bg-blue-600 focus:bg-blue-700 focus:outline-none"
          @click="moveUp(index)"
        >
        ...
        <button
          ...
          type="button"
          class="ml-2 rounded-md bg-red-500 px-2 py-2 font-bold text-white hover:bg-red-600 focus:bg-red-700 focus:outline-none"
          @click="remove(index)"
        >
