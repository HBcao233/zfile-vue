  ...
  <div class="flex h-full min-h-screen items-center justify-center bg-gray-100 text-gray-900">
    <div class="flex h-full max-w-screen-lg flex-1 bg-white shadow-xl sm:rounded-xl lg:h-auto">
      <div class="hidden flex-1 rounded-l-xl bg-gray-50 text-center lg:flex">
        <div class="zfile-login-logo m-12 w-full bg-contain bg-center bg-no-repeat xl:m-16" />
      </div>
            ...
            >
              <el-form-item class="box animate__animated animate__fadeInUp" prop="username">
                <el-input
                  ...
                  @input="loadLoginVerifyMode"
                  @change="loadLoginVerifyMode"
                />
              </el-form-item>
              ...
              <el-form-item class="!mb-0">
                <div class="flex w-full items-center justify-center space-x-4">
                  <a
                    ...
                    :href="
                      concatPath(globalConfigStore.serverAddress, 'sso', item.provider, 'login')
                    "
                  >
                    ...
                    <template #content>
                      <div>
                        ...
                        <a
                          target="_blank"
                          class="text-blue-400"
                          href="https://docs.zfile.vip/config/config-debug"
                        >
                          点击可前往文档查看操作方式
                        </a>
                      </div>
...
let formRules = ref({
  username: [{ required: true, message: '账号不能为空', trigger: ['change', 'blur'] }],
