...
export default function useSsoConfig() {
  ...
  const formRules = ref({
    ...
    name: [{ required: true, message: '请输入服务商名称', trigger: ['change'] }],
    icon: [{ required: true, message: '请输入服务商图标', trigger: ['change'] }],
    clientId: [{ required: true, message: '请输入 ClientId', trigger: ['change'] }],
    clientSecret: [{ required: true, message: '请输入 ClientSecret', trigger: ['change'] }],
    authUrl: [{ required: true, message: '请输入授权端点', trigger: ['change'] }],
    tokenUrl: [{ required: true, message: '请输入 Token 端点', trigger: ['change'] }],
    userInfoUrl: [{ required: true, message: '请输入用户信息端点', trigger: ['change'] }],
    scope: [{ required: true, message: '请输入授权范围', trigger: ['change'] }],
    bindingField: [{ required: true, message: '请输入绑定字段', trigger: ['change'] }],
